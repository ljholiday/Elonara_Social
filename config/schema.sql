...
CREATE TABLE `member_identities` (
  ...
  `oauth_provider` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `oauth_scopes` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  ...
  `oauth_access_token` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
  `oauth_refresh_token` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
  `oauth_token_expires_at` datetime DEFAULT NULL,
  `oauth_metadata` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci,
  `oauth_connected_at` datetime DEFAULT NULL,
  `needs_reauth` tinyint(1) NOT NULL DEFAULT '0',
  `oauth_last_error` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
